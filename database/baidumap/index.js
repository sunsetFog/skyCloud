...
let allKey = 'http://mock-api-success.com'
 ...
 * @param
 */
Mock.mock(allKey + "/role/selectDefaultCity", "post", selectDefaultCity);
/**
 * 选择城市
 * @param
 */
Mock.mock(allKey + "/mktinformationoperativemenu/orgCityListFull", "post", orgCityListFull);
/**
 * 项目列表
 * @param
 */
Mock.mock(allKey + "/priceAnalysis/allCityPriceAnalysis", "post", allCityPriceAnalysis);
/**
 * 通过城市搜索项目
 * @param
 */
Mock.mock(allKey + "/priceAnalysis/selectProjectByCity", "post", selectProjectByCity);
/**
 * 搜索项目
 * @param
 */
Mock.mock(allKey + "/priceAnalysis/selectProjectByProjectName", "post", selectProjectByProjectName);
/**
 * 项目详情
 * @param
 */
Mock.mock(allKey + "/priceAnalysis/priceAnalysisList", "post", priceAnalysisList);
/**
 * 项目详情图表
 * @param
 */
Mock.mock(allKey + "/priceAnalysis/priceAnalysisTrendData", "post", priceAnalysisTrendData);
