...
Mock.mock(
    process.env.VUE_APP_MOCK_URL + '/ifin-expense/ocrTemplates/getOCRTemplate',
    'post',
    function (options) {
...
Mock.mock(
    process.env.VUE_APP_MOCK_URL + '/ifin-expense/oieOcr/uniRecognized',
    'post',
    function (options) {
...
Mock.mock(
    process.env.VUE_APP_MOCK_URL + '/ifin-expense/ocr/getRegInvoiceResult',
    'post',
    function (options) {
